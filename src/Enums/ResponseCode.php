...
namespace Classid\SsoDriver\Enums;
...
enum ResponseCode
{
    ...
    case ERR_MISSING_REQUIRED_HEADER;
    ...
    public function httpCode(): int
    {
        return match ($this) {
            ...
            self::ERR_VALIDATION, self::ERR_INVALID_ACTION => Response::HTTP_UNPROCESSABLE_ENTITY,
            ...
            self::ERR_UNKNOWN, self::ERR_METHOD_NOT_IMPLEMENTED => Response::HTTP_INTERNAL_SERVER_ERROR,
            self::ERR_FORBIDDEN_ACCESS, self::ERR_ACTION_UNAUTHORIZED => Response::HTTP_FORBIDDEN,
